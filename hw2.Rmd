...
=======
covid <- covid %>% 
  select(location, continent, date, population_density, total_deaths, reproduction_rate, people_vaccinated_per_hundred, people_fully_vaccinated_per_hundred, total_boosters_per_hundred, tests_per_case, handwashing_facilities, human_development_index)

>>>>>>> 0a68d050efc8679ae2631dd02cd340329e95c06a
