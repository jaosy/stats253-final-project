...
mod1 <- fit(lm_spec,
            total_cases ~ population_density+total_deaths+reproduction_rate+people_vaccinated_per_hundred, 
            data = covid)
...
mod3 <- fit(lm_spec,
            total_cases ~ reproduction_rate+population_density, 
            data = covid)

mod4 <- fit(lm_spec,
            total_cases ~ reproduction_rate+population_density+people_vaccinated_per_hundred, 
            data = covid)

mod5 <- fit(lm_spec,
            total_cases ~ reproduction_rate+population_density+people_vaccinated_per_hundred+total_boosters_per_hundred, 
            data = covid)

mod6 <- fit(lm_spec,
            total_cases ~ reproduction_rate+population_density+handwashing_facilities+human_development_index, 
            data = covid)

mod7 <- fit(lm_spec,
            total_cases ~ .,  # The . means all predictors
            data = covid) 

covid_rec_ols <- recipe(total_cases ~ .,  data = covid) %>%
